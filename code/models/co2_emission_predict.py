...
# Rename the column
data.rename(columns={'Fuel_Consumption_in_City(L/100 km)': 'Fuel_Consumption_in_City'}, inplace=True)

data.rename(columns={'Fuel_Consumption_in_City_Hwy(L/100 km)': 'Fuel_Consumption_in_City_Hwy'}, inplace=True)

data.rename(columns={'Fuel_Consumption_in_City_comb(L/100 km)': 'Fuel_Consumption_in_City_comb'}, inplace=True)
